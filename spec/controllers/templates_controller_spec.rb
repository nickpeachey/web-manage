  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved template as @template" do
        ...
        post :create, {:template => { "title" => "invalid value" }}, valid_session
        assigns(:template).should be_a_new(Template)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested template" do
        ...
        Template.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => template.to_param, :template => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the template as @template" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Template.any_instance.stub(:save).and_return(false)
        put :update, {:id => template.to_param, :template => { "title" => "invalid value" }}, valid_session
        assigns(:template).should eq(template)
      end
